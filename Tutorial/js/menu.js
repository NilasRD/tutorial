...
tween.to({angle: -2}, 250).easing(Phaser.Easing.Circular.InOut);
// Then rotate the label to +2 degrees in 500ms
tween.to({angle: 2}, 500).easing(Phaser.Easing.Circular.InOut );
// Then rotate the label to 0 degrees in 500ms
tween.to({angle: 0}, 250).easing(Phaser.Easing.Circular.InOut );
